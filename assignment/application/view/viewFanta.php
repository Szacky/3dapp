...
<html lang="en">
  <head>
    ...
    <title>X3D model for Fanta Can</title>
  ...
  <body>
    ...
    <div class="container1">  
      <img src="../application/assets/images/fanta-orange-brand-page-desktop-1600x700.jpg" alt="Coca-Cola Original Brand Page" class="p1">
      <div class="text-overlay" id="click-link">Click ↓.</div>
    </div>

    <div class ="title3">
      <img src="../application/assets/images/fanta-logo-original.png" class="p2">
      <p>Fanta</p>
      <h1>Bright, bubbly, instantly refreshing and great tasting. Fanta is made with 100% natural flavours and is caffeine free.  </h1>
      <h1>Fanta is available in a variety of real fruit flavours.</h1>
      <div class="p2"><img src="../application/assets/images/fanta-organe-600x400-11.png" class="p3"></div>
    </div>
      ...
      <div class="container main_contents"> <!-- Start SPA Contents -->
              ...
              <div class="col-sm-8">
                  <div class="card text-left">
                      ...
                      <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                          <a id="navSprite" class="nav-link" href="apiColaCan">Cola</a>
                          </li>
                          <li class="nav-item">
                          <a id="navSprite" class="nav-link" href="apiSprite">Sprite</a>
                          </li>
                          <li class="nav-item">
                          <a id="navPepper" class="nav-link active" href="apiFanta">Fanta</a>
                          </li>
                      </ul>
                      </div>
                      ...
                      <!-- Coke X3D model -->
                      <div id="coke">
                          <div  class="card-title drinksText"><h2>Fanta X3D Model</h2></div>
        ...
        <div class="row" >
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title drinksText"><h2>Fanta</h2></div>
                        <div class="card-subtitle drinksText"><h3>Germany, WWII</h3></div>
                        <div class="card-text drinksText"><p>Bright, bubbly, instantly refreshing and great tasting. Fanta is made with 100% natural flavours and is caffeine free. Fanta is available in a variety of real fruit flavours.</p></div>   
  ...
  <style>
    ...
    .title1 p {
      ...
      .nav-tabs .nav-link.active, .nav-tabs .nav-itnav-tabem.show .nav-link {
        ...
        background-color: #f88f05; /* Blue color for background */
