...
<html lang="en">
  <head>
    ...
    <title>X3D model for Sprite Can</title>
  ...
  <body>
    ...
    <div class="container1">  
      <img src="../application/assets/images/sprite-brand-page-desktop-2023.png" alt="Coca-Cola Original Brand Page" class="p1">
      <div class="text-overlay" id="click-link">Click ↓.</div>
    </div>

    <div class ="title1">
      <img src="../application/assets/images/sprite-logo-2013.png" class="p2">
      <p>Sprite</p>
      <h1>Crisp, refreshing and clean-tasting, Sprite is a lemon and lime-flavoured soft drink. </h1>
      <h1>shop shelves back in 1961 and today it’s sold in more than 190 countries.</h1>
      <div class="p2"><img src="../application/assets/images/sprite-500ml-2023.png" class="p3"></div>
    </div>
              ...
              <div class="col-sm-8">
                  <div class="card text-left">
                      ...
                      <ul class="nav nav-tabs card-header-tabs">
                           <li class="nav-item">
                          <a id="navCoke" class="nav-link" href="apiColaCan">Coke</a>
                          </li>
                          <li class="nav-item">
                          <a id="navSprite" class="nav-link active" href="apiSprite">Sprite</a>
                          </li>
                          <li class="nav-item">
  ...
  <style>
    ...
    .title1 p {
      ...
      .nav-tabs .nav-link.active, .nav-tabs .nav-itnav-tabem.show .nav-link {
        ...
        background-color: #05f86a; /* Blue color for background */
